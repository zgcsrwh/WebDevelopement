...
(5) Authentication. 
    ...
    Similarly, first we clear the exist authentication information, then scanning the "member" and "admin_staff" collections to generate authentication function. All the password is set as "123456". 
